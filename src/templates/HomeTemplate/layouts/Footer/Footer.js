...
function Footer() {
  ...
  return (
    <footer className="py-6 bg-gray-800 text-gray-900">
      <div className="container max-w-screen-xl px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3 text-white">
            ...
            <div className="grid grid-cols-3">
              {arrHeThongRap.map((htr, index) => {
                return (
                  <div key={index}>
                    <img src={htr.logo} style={{ width: 50 }} alt="default" />
                  </div>
                );
              })}
            </div>
